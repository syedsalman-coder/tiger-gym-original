...
const english = {
  ...
  membershipForm: {
    ...
    interest: "What would you like to ask?",
    ...
    errors: {
      ...
      interest: "Select what you would like to ask about.",
      message: "Enter a message.",
    },
    template: {
