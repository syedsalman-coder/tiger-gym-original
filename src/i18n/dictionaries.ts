...
const english = {
  ...
  contactForm: {
    ...
    opened: "WhatsApp opened with your message. Review it there and tap Send; nothing was sent by this form.",
    blocked: "WhatsApp could not open automatically. Nothing was sent. Use the link below to review and send your prepared message.",
  ...
  membershipForm: {
    ...
    note: "This form prepares a WhatsApp message for you to review and send.",
    opened: "WhatsApp opened with your enquiry. Review it there and tap Send; nothing was sent by this form.",
    blocked: "WhatsApp could not open automatically. Nothing was sent. Use the link below to review and send your prepared enquiry.",
    openWhatsapp: "Open WhatsApp",
    errors: {
      name: "Enter your name.",
      phone: "Enter your phone number.",
      ...
      interest: "Select a membership interest.",
      message: "Enter a message.",
    },
    template: {
...
const arabic: Dictionary = {
  ...
  contactForm: {
    ...
    opened: "فُتح واتساب مع رسالتك. راجعها هناك ثم اضغط إرسال؛ لم يرسل هذا النموذج أي شيء.",
    blocked: "تعذّر فتح واتساب تلقائيًا ولم يُرسل أي شيء. استخدم الرابط أدناه لمراجعة رسالتك المجهّزة وإرسالها.",
  ...
  membershipForm: {
    ...
    interest: "الخيار الذي تستفسر عنه",
    selectOption: "اختر أحد الخيارات",
    message: "الرسالة",
    submit: "تجهيز استفسار العضوية",
    note: "يجهّز هذا النموذج رسالة واتساب لتراجعها وترسلها بنفسك.",
    opened: "فُتح واتساب مع استفسارك. راجعه هناك ثم اضغط إرسال؛ لم يرسل هذا النموذج أي شيء.",
    blocked: "تعذّر فتح واتساب تلقائيًا ولم يُرسل أي شيء. استخدم الرابط أدناه لمراجعة استفسارك المجهّز وإرساله.",
    openWhatsapp: "فتح واتساب",
    errors: {
      name: "أدخل اسمك.",
      phone: "أدخل رقم هاتفك.",
      ...
      interest: "اختر نوع الاستفسار عن العضوية.",
      message: "أدخل رسالتك.",
    },
    template: {
